...
export default function SelgBil() {
  return (
    <div className="container mx-auto px-4 py-24 lg:py-32 max-w-6xl">
      ...
      <div className="border border-black/10 rounded-none p-12 lg:p-16 mb-32 bg-[#fdfcfb]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 relative z-10">
          <div className="text-left flex flex-col group relative">
            ...
            <div className="w-12 h-12 bg-white border border-black/20 flex items-center justify-center mb-6 text-[#111111] z-10 group-hover:border-black group-hover:bg-black group-hover:text-white transition-all duration-300">
              <Wrench className="w-5 h-5 stroke-[1.5]" />
            </div>
            <h3 className="text-lg font-medium mb-3 text-[#111111]">1. Klargjøring</h3>
          ...
          <div className="text-left flex flex-col group relative">
            ...
            <h3 className="text-lg font-medium mb-3 text-[#111111]">2. Annonsering</h3>
            <p className="text-[#666666] font-light text-sm leading-relaxed">
          ...
          <div className="text-left flex flex-col group relative">
            ...
            <h3 className="text-lg font-medium mb-3 text-[#111111]">3. Dokumentasjon</h3>
            <p className="text-[#666666] font-light text-sm leading-relaxed">
          ...
          <div className="text-left flex flex-col group relative">
            ...
            <h3 className="text-lg font-medium mb-3 text-[#111111]">4. Garantiansvar</h3>
            <p className="text-[#666666] font-light text-sm leading-relaxed">
      ...
      <div className="grid lg:grid-cols-5 gap-16 lg:gap-20 items-start">
        ...
        <div className="lg:col-span-3 bg-transparent border border-black/10 rounded-none p-10 md:p-12">
